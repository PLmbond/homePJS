...
declare namespace pjs {
    ...
    */
    ...
    export function assignCorresponding(into: DataStucture, from: DataStucture): void;
    ...
    */
    ...
    export function editCode(value: number, code: char, currencySymbol: string): string;
    ...
    export function getDSValue(structure: DataStucture): string;
